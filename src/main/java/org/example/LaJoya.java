...
public class LaJoya extends Bufori{
    public final Double fuelTankSize = 70.00;
    public final String fuelType = "DIESEL";
    public final Integer gears = 6;
    public final Double consumptionPer100Km = 7.5;
    private Integer tireSize;
    private final double increaseConsumption = 0.08;
    private Double averageFuelConsumption;
    public double temp = 0.0;
    public LaJoya(Double availableFuel, String chassis) {
